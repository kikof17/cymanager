...
129	Fabry Raimundo	SalutCestFrankLeboeuf	0	23	U25	7`),u25:h(`#	Nom	Equipe	Victoires	Age	Points
...
93	Lopez Ralph	Gros Braquets	0	18	8`),u21:h(`#	Nom	Equipe	Victoires	Age	Points
...
59	El Gourch Mohamed	Ultinam Besac Cycling	0	18	15`)},_=t();function v(e){if(!e)return!1;let t=s(e);if(!t)return!1;let n=new Date(t);if(Number.isNaN(n.getTime()))return!1;let r=new Date(`${m}T23:59:59`);return n.getTime()>r.getTime()}function y(e,t){let n=new Map;return e.forEach(e=>{n.set(e.name,{...e})}),t.forEach(e=>{let t=n.get(e.name);if(t){n.set(e.name,{...t,team:e.team||t.team,points:t.points+e.points});return}n.set(e.name,{rank:2**53-1,name:e.name,team:e.team,points:e.points})}),Array.from(n.values()).sort((e,t)=>t.points===e.points?e.rank===t.rank?e.name.localeCompare(t.name,`fr`):e.rank-t.rank:t.points-e.points).map((e,t)=>({...e,rank:t+1}))}function b(e){c(e)}function x(e){let t=new Map;return e.forEach(({team:e,points:n})=>{e&&t.set(e,(t.get(e)||0)+n)}),Array.from(t.entries()).map(([e,t])=>({team:e,points:t})).sort((e,t)=>t.points-e.points)}function S(e){return e===1?`1er`:e===2?`2nd`:e===3?`3eme`:`${e}eme`}function C(e){return e===`u25`?`U25`:e===`u21`?`U21`:`Pro`}function w(e,t){return t===`u25`?e.u25:t===`u21`?e.u21:e.pro}function T(e){return[{value:`pro`,label:`Pro (Division ${e.pro||`-`})`},{value:`u25`,label:`U25 (Division ${e.u25||`-`})`},{value:`u21`,label:`U21 (Division ${e.u21||`-`})`}]}function E(){let e=f(),t=d(),n={pro:t.divisionPro,u25:t.divisionU25,u21:t.divisionU21},r=o().filter(e=>e.id.startsWith(`calendar-`)),i=!1;Object.keys(e).forEach(t=>{r.some(e=>e.id===t)||(delete e[t],i=!0)}),Object.entries(e).forEach(([t,n])=>{typeof n==`string`&&(e[t]={result:n,category:a(n,r.find(e=>e.id===t))},i=!0)}),i&&b(l(e,r).results);let s=new Map,c=new Map,p=new Map,m=new Map,h=new Map,_=new Map;return Object.entries(e).forEach(([e,t])=>{let n=a(t,r.find(t=>t.id===e)),i=t;typeof t==`object`&&t&&`result`in t&&`category`in t&&(i=t.result);let o=u({[e]:i}),l=n===`u25`?c:n===`u21`?p:s,d=n===`u25`?h:n===`u21`?_:m,f=v(r.find(t=>t.id===e));o.forEach(({name:e,team:t,points:n})=>{if(!l.has(e))l.set(e,{name:e,team:t,points:n});else{let t=l.get(e);l.set(e,{...t,points:t.points+n})}if(!f)return;if(!d.has(e)){d.set(e,{name:e,team:t,points:n});return}let r=d.get(e);d.set(e,{...r,points:r.points+n})})}),{divisions:n,pro:Array.from(s.values()).sort((e,t)=>t.points-e.points),u25:Array.from(c.values()).sort((e,t)=>t.points-e.points),u21:Array.from(p.values()).sort((e,t)=>t.points-e.points),proTeams:[],u25Teams:[],u21Teams:[],mergedIndividuals:{pro:y(g.pro,Array.from(m.values())),u25:y(g.u25,Array.from(h.values())),u21:y(g.u21,Array.from(_.values()))}}}function D(){let[e,t]=(0,p.useState)(`individuel`),[n,a]=(0,p.useState)(`pro`),[o,s]=(0,p.useState)(`pro`),{divisions:c,pro:l,u25:u,u21:d,mergedIndividuals:f}=(0,p.useMemo)(()=>E(),[]),m=(0,p.useMemo)(()=>T(c),[c]),h={pro:l,u25:u,u21:d},g=f[n],v={pro:x(f.pro),u25:x(f.u25),u21:x(f.u21)},y=h[n],b=v[o],D=`Equipe ${C(n)} (Division ${w(c,n)||`-`})`,O=`Classement par equipe ${C(o)} (Division ${w(c,o)||`-`})`;return(0,_.jsxs)(`div`,{className:`page-stack page-stack-narrow`,children:[(0,_.jsx)(i,{title:`Classement`,subtitle:`Consultez les classements des equipes Pro, U25 et U21.`}),(0,_.jsxs)(`div`,{className:`ranking-tabs-row`,children:[(0,_.jsx)(`button`,{className:e===`individuel`?`tab-btn tab-btn-active`:`tab-btn`,onClick:()=>t(`individuel`),type:`button`,children:`Classement individuel`}),(0,_.jsx)(`button`,{className:e===`equipes`?`tab-btn tab-btn-active`:`tab-btn`,onClick:()=>t(`equipes`),type:`button`,children:`Classement par equipe`})]}),e===`individuel`&&(0,_.jsxs)(`div`,{className:`page-stack`,children:[(0,_.jsxs)(`div`,{className:`select-row ranking-filter-row`,children:[(0,_.jsx)(`label`,{htmlFor:`individual-ranking-category`,className:`select-label`,children:`Type d'equipe :`}),(0,_.jsx)(`select`,{id:`individual-ranking-category`,className:`input select-input`,value:n,onChange:e=>a(e.target.value),children:m.map(e=>(0,_.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,_.jsx)(r,{title:`Base ${C(n)} intégrée`,children:(0,_.jsx)(`div`,{className:`message-box`,children:(0,_.jsxs)(`p`,{className:`muted`,children:[`Classement de départ intégré au `,`2026-04-18`,`. A partir de la prochaine course enregistrée après cette date, les points seront ajoutés automatiquement à cette base.`]})})}),(0,_.jsx)(r,{title:D,children:g.length>0?(0,_.jsx)(`div`,{className:`table-container`,children:(0,_.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,_.jsx)(`thead`,{children:(0,_.jsxs)(`tr`,{children:[(0,_.jsx)(`th`,{children:`Cl.`}),(0,_.jsx)(`th`,{children:`Nom`}),(0,_.jsx)(`th`,{children:`Equipe`}),(0,_.jsx)(`th`,{children:`Victoires`}),(0,_.jsx)(`th`,{children:`Age`}),(0,_.jsx)(`th`,{children:`Cat.`}),(0,_.jsx)(`th`,{children:`Points`})]})}),(0,_.jsx)(`tbody`,{children:g.map(e=>(0,_.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,_.jsx)(`td`,{children:S(e.rank)}),(0,_.jsx)(`td`,{children:e.name}),(0,_.jsx)(`td`,{children:e.team}),(0,_.jsx)(`td`,{children:e.wins??`-`}),(0,_.jsx)(`td`,{children:e.age??`-`}),(0,_.jsx)(`td`,{children:e.categoryLabel||`-`}),(0,_.jsx)(`td`,{children:e.points})]},`${e.rank}-${e.name}`))})]})}):y.length===0?(0,_.jsx)(`div`,{children:`Aucun classement disponible.`}):(0,_.jsx)(`div`,{className:`table-container`,children:(0,_.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,_.jsx)(`thead`,{children:(0,_.jsxs)(`tr`,{children:[(0,_.jsx)(`th`,{children:`Cl.`}),(0,_.jsx)(`th`,{children:`Nom`}),(0,_.jsx)(`th`,{children:`Equipe`}),(0,_.jsx)(`th`,{children:`Points`})]})}),(0,_.jsx)(`tbody`,{children:y.map((e,t)=>(0,_.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,_.jsx)(`td`,{children:S(t+1)}),(0,_.jsx)(`td`,{children:e.name}),(0,_.jsx)(`td`,{children:e.team}),(0,_.jsx)(`td`,{children:e.points})]},`${e.name}-${t}`))})]})})})]}),e===`equipes`&&(0,_.jsxs)(`div`,{className:`page-stack`,children:[(0,_.jsx)(`div`,{className:`message-box`,children:(0,_.jsx)(`p`,{className:`muted`,children:`Le classement par equipe reste pour l'instant base sur les resultats locaux sauvegardes. L'import global des equipes sera raccorde ensuite.`})}),(0,_.jsxs)(`div`,{className:`select-row ranking-filter-row`,children:[(0,_.jsx)(`label`,{htmlFor:`team-ranking-category`,className:`select-label`,children:`Type d'equipe :`}),(0,_.jsx)(`select`,{id:`team-ranking-category`,className:`input select-input`,value:o,onChange:e=>s(e.target.value),children:m.map(e=>(0,_.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,_.jsx)(r,{title:O,children:b.length===0?(0,_.jsx)(`div`,{children:`Aucun classement disponible.`}):(0,_.jsx)(`div`,{className:`table-container`,children:(0,_.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,_.jsx)(`thead`,{children:(0,_.jsxs)(`tr`,{children:[(0,_.jsx)(`th`,{children:`Cl.`}),(0,_.jsx)(`th`,{children:`Equipe`}),(0,_.jsx)(`th`,{children:`Points`})]})}),(0,_.jsx)(`tbody`,{children:b.map((e,t)=>(0,_.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,_.jsx)(`td`,{children:S(t+1)}),(0,_.jsx)(`td`,{children:e.team}),(0,_.jsx)(`td`,{children:e.points})]},`${e.team}-${t}`))})]})})})]})]})}export{D as default};