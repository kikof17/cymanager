...
59	El Gourch Mohamed	Ultinam Besac Cycling	0	18	15`)},y=n();function b(){return typeof window>`u`?``:[window.localStorage.getItem(`cymanager:results`)??``,window.localStorage.getItem(`cymanager:tour-gc-results`)??``,window.localStorage.getItem(`cymanager:manual-todos`)??``,window.localStorage.getItem(`cymanager:club-settings`)??``].join(`||`)}function x(e){if(!e)return!1;let t=u(e);if(!t)return!1;let n=new Date(t);if(Number.isNaN(n.getTime()))return!1;let r=new Date(`${g}T23:59:59`);return n.getTime()>r.getTime()}function S(e,t){let n=new Map;return e.forEach(e=>{n.set(e.name,{...e})}),t.forEach(e=>{let t=n.get(e.name);if(t){n.set(e.name,{...t,team:e.team||t.team,points:t.points+e.points});return}n.set(e.name,{rank:2**53-1,name:e.name,team:e.team,points:e.points})}),Array.from(n.values()).sort((e,t)=>t.points===e.points?e.rank===t.rank?e.name.localeCompare(t.name,`fr`):e.rank-t.rank:t.points-e.points).map((e,t)=>({...e,rank:t+1}))}function C(e){r(e)}function w(e){let t=new Map;return e.forEach(({team:e,points:n})=>{e&&t.set(e,(t.get(e)||0)+n)}),Array.from(t.entries()).map(([e,t])=>({team:e,points:t})).sort((e,t)=>t.points-e.points)}function T(e){return e===1?`1er`:e===2?`2nd`:e===3?`3eme`:`${e}eme`}function E(e){return e===`u25`?`U25`:e===`u21`?`U21`:`Pro`}function D(e,t){return t===`u25`?e.u25:t===`u21`?e.u21:e.pro}function O(e){return[{value:`pro`,label:`Pro (Division ${e.pro||`-`})`},{value:`u25`,label:`U25 (Division ${e.u25||`-`})`},{value:`u21`,label:`U21 (Division ${e.u21||`-`})`}]}function k(){let e=i(),t=o(),n={pro:t.divisionPro,u25:t.divisionU25,u21:t.divisionU21},r=l().filter(e=>e.source===`manual`&&e.category===`courses`),u=!1;Object.keys(e).forEach(t=>{r.some(e=>e.id===t)||(delete e[t],u=!0)}),Object.entries(e).forEach(([t,n])=>{typeof n==`string`&&(e[t]={result:n,category:d(n,r.find(e=>e.id===t))},u=!0)}),u&&C(s(e,r).results);let f=new Map,p=new Map,h=new Map,g=new Map,_=new Map,y=new Map;Object.entries(e).forEach(([e,t])=>{let n=d(t,r.find(t=>t.id===e)),i=t;typeof t==`object`&&t&&`result`in t&&`category`in t&&(i=t.result);let o=a({[e]:i}),s=n===`u25`?p:n===`u21`?h:f,c=n===`u25`?_:n===`u21`?y:g,l=x(r.find(t=>t.id===e));o.forEach(({name:e,team:t,points:n})=>{if(!s.has(e))s.set(e,{name:e,team:t,points:n});else{let t=s.get(e);s.set(e,{...t,points:t.points+n})}if(!l)return;if(!c.has(e)){c.set(e,{name:e,team:t,points:n});return}let r=c.get(e);c.set(e,{...r,points:r.points+n})})});let b=m();return Object.entries(b).forEach(([e,t])=>{let n=r.filter(t=>t.tourKey===e);if(n.length===0)return;let i=c(n[0]),o=[...n].sort((e,t)=>(e.stageNumber??0)-(t.stageNumber??0)),s=o[o.length-1],l=a({[`gc-${e}`]:t}),u=i===`u25`?p:i===`u21`?h:f,d=i===`u25`?_:i===`u21`?y:g,m=x(s);l.forEach(({name:e,team:t,points:n})=>{if(!u.has(e))u.set(e,{name:e,team:t,points:n});else{let t=u.get(e);u.set(e,{...t,points:t.points+n})}if(!m)return;if(!d.has(e)){d.set(e,{name:e,team:t,points:n});return}let r=d.get(e);d.set(e,{...r,points:r.points+n})})}),{divisions:n,pro:Array.from(f.values()).sort((e,t)=>t.points-e.points),u25:Array.from(p.values()).sort((e,t)=>t.points-e.points),u21:Array.from(h.values()).sort((e,t)=>t.points-e.points),proTeams:[],u25Teams:[],u21Teams:[],mergedIndividuals:{pro:S(v.pro,Array.from(g.values())),u25:S(v.u25,Array.from(_.values())),u21:S(v.u21,Array.from(y.values()))}}}function A(){let[e,t]=(0,h.useState)(`individuel`),[n,r]=(0,h.useState)(`pro`),[i,a]=(0,h.useState)(`pro`),[o,s]=(0,h.useState)(()=>b());(0,h.useEffect)(()=>{function e(){let e=b();s(t=>t===e?t:e)}function t(t){t.key&&new Set([`cymanager:results`,`cymanager:tour-gc-results`,`cymanager:manual-todos`,`cymanager:club-settings`]).has(t.key)&&e()}window.addEventListener(`storage`,t),window.addEventListener(`focus`,e),document.addEventListener(`visibilitychange`,e),window.addEventListener(`cymanager:finance-updated`,e),window.addEventListener(`cymanager:results-updated`,e),window.addEventListener(`cymanager:tour-gc-results-updated`,e);let n=window.setInterval(e,1500);return()=>{window.removeEventListener(`storage`,t),window.removeEventListener(`focus`,e),document.removeEventListener(`visibilitychange`,e),window.removeEventListener(`cymanager:finance-updated`,e),window.removeEventListener(`cymanager:results-updated`,e),window.removeEventListener(`cymanager:tour-gc-results-updated`,e),window.clearInterval(n)}},[]);let{divisions:c,pro:l,u25:u,u21:d,mergedIndividuals:m}=(0,h.useMemo)(()=>k(),[o]),g=(0,h.useMemo)(()=>O(c),[c]),_={pro:l,u25:u,u21:d},v=m[n],x={pro:w(_.pro),u25:w(_.u25),u21:w(_.u21)},S=_[n],C=x[i],A=`Equipe ${E(n)} (Division ${D(c,n)||`-`})`,j=`Classement par equipe ${E(i)} (Division ${D(c,i)||`-`})`;return(0,y.jsxs)(`div`,{className:`page-stack page-stack-narrow`,children:[(0,y.jsx)(p,{title:`Classement`,subtitle:`Consultez les classements des equipes Pro, U25 et U21.`}),(0,y.jsxs)(`div`,{className:`ranking-tabs-row`,children:[(0,y.jsx)(`button`,{className:e===`individuel`?`tab-btn tab-btn-active`:`tab-btn`,onClick:()=>t(`individuel`),type:`button`,children:`Classement individuel`}),(0,y.jsx)(`button`,{className:e===`equipes`?`tab-btn tab-btn-active`:`tab-btn`,onClick:()=>t(`equipes`),type:`button`,children:`Classement par equipe`})]}),e===`individuel`&&(0,y.jsxs)(`div`,{className:`page-stack`,children:[(0,y.jsxs)(`div`,{className:`select-row ranking-filter-row`,children:[(0,y.jsx)(`label`,{htmlFor:`individual-ranking-category`,className:`select-label`,children:`Type d'equipe :`}),(0,y.jsx)(`select`,{id:`individual-ranking-category`,className:`input select-input`,value:n,onChange:e=>r(e.target.value),children:g.map(e=>(0,y.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,y.jsx)(f,{title:`Base ${E(n)} intégrée`,children:(0,y.jsx)(`div`,{className:`message-box`,children:(0,y.jsxs)(`p`,{className:`muted`,children:[`Classement de départ intégré au `,`2026-04-18`,`. A partir de la prochaine course enregistrée après cette date, les points seront ajoutés automatiquement à cette base.`]})})}),(0,y.jsx)(f,{title:A,children:S.length>0?(0,y.jsx)(`div`,{className:`table-container`,children:(0,y.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,y.jsx)(`thead`,{children:(0,y.jsxs)(`tr`,{children:[(0,y.jsx)(`th`,{children:`Cl.`}),(0,y.jsx)(`th`,{children:`Nom`}),(0,y.jsx)(`th`,{children:`Equipe`}),(0,y.jsx)(`th`,{children:`Points`})]})}),(0,y.jsx)(`tbody`,{children:S.map((e,t)=>(0,y.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,y.jsx)(`td`,{children:T(t+1)}),(0,y.jsx)(`td`,{children:e.name}),(0,y.jsx)(`td`,{children:e.team}),(0,y.jsx)(`td`,{children:e.points})]},`${e.name}-${t}`))})]})}):v.length>0?(0,y.jsx)(`div`,{className:`table-container`,children:(0,y.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,y.jsx)(`thead`,{children:(0,y.jsxs)(`tr`,{children:[(0,y.jsx)(`th`,{children:`Cl.`}),(0,y.jsx)(`th`,{children:`Nom`}),(0,y.jsx)(`th`,{children:`Equipe`}),(0,y.jsx)(`th`,{children:`Victoires`}),(0,y.jsx)(`th`,{children:`Age`}),(0,y.jsx)(`th`,{children:`Cat.`}),(0,y.jsx)(`th`,{children:`Points`})]})}),(0,y.jsx)(`tbody`,{children:v.map(e=>(0,y.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,y.jsx)(`td`,{children:T(e.rank)}),(0,y.jsx)(`td`,{children:e.name}),(0,y.jsx)(`td`,{children:e.team}),(0,y.jsx)(`td`,{children:e.wins??`-`}),(0,y.jsx)(`td`,{children:e.age??`-`}),(0,y.jsx)(`td`,{children:e.categoryLabel||`-`}),(0,y.jsx)(`td`,{children:e.points})]},`${e.rank}-${e.name}`))})]})}):(0,y.jsx)(`div`,{children:`Aucun classement disponible.`})})]}),e===`equipes`&&(0,y.jsxs)(`div`,{className:`page-stack`,children:[(0,y.jsx)(`div`,{className:`message-box`,children:(0,y.jsx)(`p`,{className:`muted`,children:`Le classement par equipe reste pour l'instant base sur les resultats locaux sauvegardes. L'import global des equipes sera raccorde ensuite.`})}),(0,y.jsxs)(`div`,{className:`select-row ranking-filter-row`,children:[(0,y.jsx)(`label`,{htmlFor:`team-ranking-category`,className:`select-label`,children:`Type d'equipe :`}),(0,y.jsx)(`select`,{id:`team-ranking-category`,className:`input select-input`,value:i,onChange:e=>a(e.target.value),children:g.map(e=>(0,y.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,y.jsx)(f,{title:j,children:C.length===0?(0,y.jsx)(`div`,{children:`Aucun classement disponible.`}):(0,y.jsx)(`div`,{className:`table-container`,children:(0,y.jsxs)(`table`,{className:`data-table styled-table`,children:[(0,y.jsx)(`thead`,{children:(0,y.jsxs)(`tr`,{children:[(0,y.jsx)(`th`,{children:`Cl.`}),(0,y.jsx)(`th`,{children:`Equipe`}),(0,y.jsx)(`th`,{children:`Points`})]})}),(0,y.jsx)(`tbody`,{children:C.map((e,t)=>(0,y.jsxs)(`tr`,{className:e.team===`Kritoff Team`?`highlight-row`:void 0,children:[(0,y.jsx)(`td`,{children:T(t+1)}),(0,y.jsx)(`td`,{children:e.team}),(0,y.jsx)(`td`,{children:e.points})]},`${e.team}-${t}`))})]})})})]})]})}export{A as default};